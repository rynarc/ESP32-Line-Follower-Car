...
float base_speed    = 600;
float Kp            = 135;
float Kd            = 350;
float motor1_trim   = 1.04;    // motor 1 lebih lemah, dikuatkan (atur 1.01–1.10)
...
void loop() {
	switch (programState) {
		...
		case 1: {
			...
			// Motor 1 lebih lemah → trim pada motor 1
			float left  = (base_speed * motor1_trim) + turn;
